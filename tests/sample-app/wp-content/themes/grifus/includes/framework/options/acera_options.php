...
$options = array(
/*============================================================================*/
array("type" => "section","icon" => "dashicons-admin-settings","title" => __( "Configuration", "mundothemes" ),"id" => "general","expanded" => "true"),
array("type" => "section","icon" => "dashicons-welcome-widgets-menus","title" => __( "Design and structure", "mundothemes" ),"id" => "general2","expanded" => "false"),
...
array(
	...
	"under_section" => "api-config", 
    "type" => "select", 
    "name" => __('Language API','mundothemes'), 
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "tmdbidioma", 
    "options" => array(
			"ar-AR" => __('Arabic (ar-AR)','mundothemes'),
			"bs-BS" => __('Bosnian (bs-BS)','mundothemes'),
			"bg-BG" => __('Bulgarian (bg-BG)','mundothemes'),
			"hr-HR" => __('Croatian (hr-HR)','mundothemes'),
			"cs-CZ" => __('Czech (cs-CZ)','mundothemes'),
			"da-DK" => __('Danish (da-DK)','mundothemes'),
			"nl-NL" => __('Dutch (nl-NL)','mundothemes'),
			"en-US" => __('English (en-US)','mundothemes'),
			"fi-FI" => __('Finnish (fi-FI)','mundothemes'),
			"fr-FR" => __('French (fr-FR)','mundothemes'),
			"de-DE" => __('German (de-DE)','mundothemes'),
			"el-GR" => __('Greek (el-GR)','mundothemes'),
			"he-IL" => __('Hebrew (he-IL)','mundothemes'),
			"hu-HU" => __('Hungarian (hu-HU)','mundothemes'),
			"is-IS" => __('Icelandic (is-IS)','mundothemes'),
			"id-ID" => __('Indonesian (id-ID)','mundothemes'),
			"it-IT" => __('Italian (it-IT)','mundothemes'),
			"ko-KR" => __('Korean (ko-KR)','mundothemes'),
			"lb-LB" => __('Letzeburgesch (lb-LB)','mundothemes'),
			"lt-LT" => __('Lithuanian (lt-LT)','mundothemes'),
			"zh-CN" => __('Mandarin (zh-CN)','mundothemes'),
			"fa-IR" => __('Persian (fa-IR)','mundothemes'),
			"pl-PL" => __('Polish (pl-PL)','mundothemes'),
			"pt-PT" => __('Portuguese (pt-PT)','mundothemes'),
			"pt-BR" => __('Portuguese (pt-BR)','mundothemes'),
			"ro-RO" => __('Romanian (ro-RO)','mundothemes'),
			"ru-RU" => __('Russian (ru-RU)','mundothemes'),
			"sk-SK" => __('Slovak (sk-SK)','mundothemes'),
			"es-ES" => __('Spanish (es-ES)','mundothemes'),
			"sv-SE" => __('Swedish (sv-SE)','mundothemes'),
			"th-TH" => __('Thai (th-TH)','mundothemes'),
			"tr-TR" => __('Turkish (tr-TR)','mundothemes'),
			"tw-TW" => __('Twi (tw-TW)','mundothemes'),
			"uk-UA" => __('Ukrainian (uk-UA)','mundothemes'),
			"vi-VN" => __('Vietnamese (vi-VN)','mundothemes')
		), 
    "desc" => __('Select language','mundothemes'),
    "default" => "en-US"
),
array(
    "under_section" => "api-config",
...
array(
	...
	"under_section" => "general-config", 
    "type" => "pages", 
    "name" => __( "URL Add movie", "mundothemes" ),
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "add_movie", 
...
array(
	...
	"under_section" => "general-config", 
    "type" => "pages", 
    "name" => __( "URL Edit profile", "mundothemes" ), 
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "editar_perfil", 
...
array(
	...
	"under_section" => "comentarios-config", 
    "type" => "select", 
    "name" => __("Facebook Color Scheme", "mundothemes"),
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "fb_color", 
    "options" => array(
			"light" => __('light','mundothemes'),
			"dark" => __('dark','mundothemes')
		), 
...
array(
    ...
    "options" => array(
			"5" => __('5 comments','mundothemes'),
			"6" => __('6 comments','mundothemes'),
			"7" => __('7 comments','mundothemes'),
			"8" => __('8 comments','mundothemes'),
			"9" => __('9 comments','mundothemes'),
			"10" => __('10 comments','mundothemes'),
			"11" => __('11 comments','mundothemes'),
			"12" => __('12 comments','mundothemes'),
			"13" => __('13 comments','mundothemes'),
			"14" => __('14 comments','mundothemes'),
			"15" => __('15 comments','mundothemes')
		),
