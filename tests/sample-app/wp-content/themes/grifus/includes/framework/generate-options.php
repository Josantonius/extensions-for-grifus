   ...
   jQuery('#acera-settings').submit(function() { 
      jQuery(this).ajaxSubmit({
         success: function(){
            ...
            jQuery('.saveMessage').append("<p><?php echo htmlentities(__('Settings saved.'),ENT_QUOTES); ?></p>").show();
         }, 
         timeout: 5000
      }); 
...
<p><?php _e('Invalid license, it is possible that some of the options may not work correctly','mundothemes') ?></p>
</div>
<?php } ?>
...
<div id="acera-meta-info">
<h2><a href="https://mundothemes.com/forums/foro/5/grifus/" target="_blank"><?php _e('Support forum','mundothemes'); ?></a></h2>
<h2><a href="https://mundothemes.com/cpa/soporte/index.php?mail=<?php echo get_option("admin_email"); ?>&licencia=<?php echo get_option('edd_sample_theme_license_key'); ?>&theme=<?php echo THEME_NAME; ?>&version=<?php echo THEME_VERSION; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=356,height=600'); return false;"><?php _e('Request Support','mundothemes'); ?></a></h2>
</div>
</div>
...
<input name="publish" class="dt_button button button-primary button-large" type="submit" value="<?php _e('Save Changes','mundothemes'); ?>" id="publish" />
...
<div class="dt_footer">
<input name="save" class="dt_button button button-primary button-large" type="submit" value="<?php _e('Save Changes','mundothemes'); ?>" />
<div class="saveResult"></div>
</div>
</div> 
...
<span class="upload acera_upload acera-button-blue" id="<?php echo $value['id']; ?>"><?php _e('Upload','mundothemes'); ?></span>
<?php if (get_option($value['id'])): ?>
<span type="button" class="acera_remove acera-button" id="remove_<?php echo $value['id']; ?>"><?php _e('Remove','mundothemes'); ?></span>
<?php endif; ?>
