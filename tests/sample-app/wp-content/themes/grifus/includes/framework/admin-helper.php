...
if (!function_exists('acera_admin_head')) { function acera_admin_head() { if ( isset($_GET['page']) && $_GET['page'] == 'grifus' ) { ?>
...
if (!function_exists('acera_admin_head_2')) { function acera_admin_head_2() { if ( isset($_GET['page']) && $_GET['page'] == 'mundothemes' ) { ?>
...
function myPlugin_admin_scripts() {
   if ( is_admin() ){ 
      if ( isset($_GET['page']) && $_GET['page'] == 'grifus' ) {
